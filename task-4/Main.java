...
public class Main {
    public static void main(String[] args) {
        ...
        admin.getSorted(Choice.ALL_ROOMS);
        ...
        admin.getSorted(Choice.FREE_ROOMS);
        ...
        admin.getSorted(Choice.GUESTS);

        System.out.println("\nОбщее число свободных номеров: " + admin.totalNumberOf(Choice.FREE_ROOMS));

        System.out.println("\nОбщее число постояльцев: " + admin.totalNumberOf(Choice.GUESTS));
        ...
        admin.getSorted(Choice.ROOMS_AND_SERVICES);

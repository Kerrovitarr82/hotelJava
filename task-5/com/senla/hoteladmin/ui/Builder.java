...
public class Builder {
    ...
    public Builder(RoomController roomController, GuestController guestController, MaintenanceController maintenanceController) {
    ...
    public void buildMenus() {
        ...
        Collections.addAll(roomSectionMenu.getMenuItems(),
                ...
                new MenuItem("12) Выход", null, rootMenu));
        ...
        Collections.addAll(guestSectionMenu.getMenuItems(),
                ...
                new MenuItem("5) Выход", null, rootMenu));
        ...
        Collections.addAll(maintenanceSectionMenu.getMenuItems(),
                ...
                new MenuItem("4) Сортировка услуг", new GetMaintenanceSortedByPriceAction(maintenanceController), null),
                new MenuItem("5) Сортировка услуг гостя", new GetMaintenanceForGuestSortedByPriceByDateAction(maintenanceController), null),
                new MenuItem("6) Выход", null, rootMenu));
    }
